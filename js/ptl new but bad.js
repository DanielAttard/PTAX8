...
$("#ptl_reset","#md_reset").click(function(){
		window.location = '/';
	 $("#ptl_data","#md-data").val('');
	 $("#ptl_lookup","#md_lookup").toggle('visibility');
});
$("#ptl_reset2","#md_reset2").click(function(){
		window.location = '/';
	 $("#ptl_data","#md_data").val('');
	 $("#ptl_lookup","#md_lookup").toggle('visibility');
});
