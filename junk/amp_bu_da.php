...
$app->post('/am/p', function () use ($app) {
    ...
    //$tmp = tempnam($dir, "AMP_");

    //$tmp = tempnam(sys_get_temp_dir(), "AMP_");

    define('USER', 'Debdulal');
    define('PASS', '4Ew3vM!CitEmhTT');
    //define('COOKIE_DIR_1', $dirname . DIRECTORY_SEPARATOR . 'tmp');
    //define('COOKIE_DIR', $tmp);
    define('COOKIE_DIR', sys_get_temp_dir());
    //dumpVar (" <br>COOKIE_DIR_1: ".COOKIE_DIR_1.'<br>');    
    //exit;
    //dumpVar ("after exit");
    ...
    // Debdulal - This function does not work either 
    $POIList = getPOIList (); 

    // Debdulal - this is the function that is not working: getPOIDetailsJSON
